"""
Django settings for fragrant_snowflake__88888 project.
...
ROOT_URLCONF = 'fragrant_snowflake__88888.urls'
...
WSGI_APPLICATION = 'fragrant_snowflake__88888.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_snowflake__88888 API",
    "DESCRIPTION": "API documentation for fragrant_snowflake__88888 App",
    "VERSION": "v1",
}
