...
## Project Structure
    ...
    ├── fragrant_snowflake__88888  # Django project configurations
...
1. Clone this repo and `cd fragrant_snowflake__88888`
...
2. Clone this repo and `cd fragrant_snowflake__88888`
